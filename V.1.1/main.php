...
<div class="nav">
    ...
    <?php endif; ?>
    <a href="main.php" style="background: #c1d9ff;">🏠 Inicio</a>
</div>

<div class="search" style="display: flex; justify-content: center; align-items: center; gap: 10px; margin: 20px 0;">
    <a href="crear_noticia.php" 
       style="display: flex; justify-content: center; align-items: center; 
              width: 40px; height: 40px; font-size: 2em; text-decoration: none; 
              background: #3f49c4; color: white; border-radius: 5px; border: none; cursor: pointer;"
       title="Crear noticia nueva">+</a>
